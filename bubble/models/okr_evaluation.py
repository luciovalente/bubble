...
class OkrEvaluation(models.Model):
    ...
    evaluation_type_id = fields.Many2one("okr.evaluation.type", required=True, tracking=True)
    with_automation = fields.Boolean(related="evaluation_type_id.with_automation", tracking=True)
